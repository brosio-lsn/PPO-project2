...
class SingleRouteTest2 {
    ...
    public void pointClosestToWorksOnHorizontalItinerary() {
        ...
        RoutePoint rp = new RoutePoint(pp, (new PointCh(SwissBounds.MIN_E, SwissBounds.MIN_N).distanceTo(pp)), p.distanceTo(pp));

        Edge e0 = new Edge(0, 1, new PointCh(SwissBounds.MIN_E, SwissBounds.MIN_N),
                new PointCh(SwissBounds.MIN_E + 100, SwissBounds.MIN_N + 100), Math.sqrt(20000),
                Functions.constant(Double.NaN));
        Edge e1 = new Edge(1, 2, new PointCh(SwissBounds.MIN_E + 100, SwissBounds.MIN_N + 100),
                new PointCh(SwissBounds.MIN_E + 200, SwissBounds.MIN_N + 200), Math.sqrt(20000),
                Functions.constant(Double.NaN));
        Edge e2 = new Edge(2, 3, new PointCh(SwissBounds.MIN_E + 200, SwissBounds.MIN_N + 200),
                new PointCh(SwissBounds.MIN_E + 300, SwissBounds.MIN_N + 300), Math.sqrt(20000),
                Functions.constant(Double.NaN));
        Edge e3 = new Edge(4, 5, new PointCh(SwissBounds.MIN_E + 300, SwissBounds.MIN_N + 300),
                new PointCh(SwissBounds.MIN_E + 400, SwissBounds.MIN_N + 400), Math.sqrt(20000),
                Functions.constant(Double.NaN));
        Edge e4 = new Edge(5, 6, new PointCh(SwissBounds.MIN_E + 400, SwissBounds.MIN_N + 400),
                new PointCh(SwissBounds.MIN_E + 500, SwissBounds.MIN_N + 500), Math.sqrt(20000),
                Functions.constant(Double.NaN));
        List<Edge> l = new ArrayList<>();
        l.add(e0);
        l.add(e1);
