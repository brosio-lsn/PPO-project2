...
//TODO ask if we should comment the attributes in a record - dans le doute, oui
public record RoutePoint(PointCh point, double position, double distanceToReference) {
    ...
    /**
     * returns the current RoutePoint if its distance to the reference is less than or
     * equal to the given RoutePoint, and the given RoutePoint otherwise
     *
    ...
    /**
     * returns the current RoutePoint if its distance to the reference is less than or equal to
