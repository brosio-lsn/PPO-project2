...
public record RoutePoint(PointCh point, double position, double distanceToReference) {
    ...
    /**
     * returns a point identical to the current RoutePoint (this) but whose position
     * is offset by the given difference (positive of negative)
     *
     * @param positionDifference the difference of position
     * @return a point identical to the current RoutePoint (this) but whose position
     * is offset by the given difference (positive of negative)
     */
    ...
    /**
     * returns the current RoutePoint if its distance to the reference is less than
     * or equal to the given RoutePoint, and the given RoutePoint otherwise
     *
     * @param that the given RoutePoint
     * @return the current RoutePoint if its distance to the reference is less than
     * or equal to the given RoutePoint, and the given RoutePoint otherwise
     */
     ...
     * thatDistanceToReference, and a new instance of RoutePoint whose attributes
